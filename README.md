...
- *Which camps offer aquatics?* (Filtering on `aquatics` finds <!--n:camps.aquatics_bare-->61<!--/n--> camps. The right answer is <!--n:camps.aquatics_closure-->323<!--/n-->.)
...
The [**live camp map**](https://sethmay.github.io/open-scout-api/starters/camp-map/) plots all <!--n:camps.current-->553<!--/n-->
camps straight from the API, and it distinguishes what it knows from what it guessed. The <!--n:camps.exact-->396<!--/n-->
surveyed coordinates are pins; the <!--n:camps.approximate-->156<!--/n--> city- or state-centroid backfills are dashed areas, because
rendering those as pins would put camps miles from the gate. Camps sharing a reservation collapse
into one marker per property, so the <!--n:camps.placeable-->552<!--/n--> placeable camps map as surveyed pins and dashed
centroid areas. The <!--n:camps.no_coord-->1<!--/n--> camp with no coordinate at all is named rather than silently dropped.

[![The live camp map: surveyed coordinates as pins, approximate coordinates collapsed into dashed areas, and a legend explaining the difference](./docs/img/camp-map.png)](https://sethmay.github.io/open-scout-api/starters/camp-map/)
...
queries, including the one that shows why filtering on `aquatics` finds <!--n:camps.aquatics_bare-->61<!--/n--> camps when the right
answer is <!--n:camps.aquatics_closure-->323<!--/n-->.
...
|---|---:|---:|---|
| [Councils](./docs/datasets.md#councils) | <!--n:councils.total-->428<!--/n--> | <!--n:councils.current-->228<!--/n--> | Councils incl. merged/renamed/defunct, with lineage |
| [Territories](./docs/datasets.md#territories) | 20 | 14 | Council Service Territories + legacy regions |
| [Camps](./docs/datasets.md#camps) | <!--n:camps.total-->553<!--/n--> | <!--n:camps.current-->553<!--/n--> | Resident, day, high-adventure + the 4 national bases |
...
**An exact match on a feature code finds <!--n:camps.aquatics_bare-->61<!--/n--> camps with water activities, out of <!--n:camps.aquatics_closure-->323<!--/n--> that have them.**
...
`map.pin(camp.lat, camp.lon)` across all <!--n:camps.current-->553<!--/n--> camps drops <!--n:camps.approximate-->156<!--/n--> pins on a city or state centroid,
which can sit many miles from the property. Read `geo_precision` first, `exact` on <!--n:camps.exact-->396<!--/n--> camps and
`approximate` on <!--n:camps.approximate-->156<!--/n-->, then style or drop the approximate ones:
