...
tools/                live pipeline: stamp_schema.py, validate_data.py, validate_examples.py,
                      ...
                      enrichment (run manually): geocode_addresses.py (coords from street addresses), elevation.py (elevation_ft from coords)
