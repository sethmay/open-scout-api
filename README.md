...
| [`v1/current/adventures.json`](https://sethmay.github.io/open-scout-api/v1/current/adventures.json) | flat list of Cub Scout adventures, with the rank(s) offering each and its `category` |
...
| [`v1/vocab/camp-program-types.json`](https://sethmay.github.io/open-scout-api/v1/vocab/camp-program-types.json) · `camp-types` · `camp-features` · `merit-badge-tags` · `adventure-categories` | controlled vocabularies: every code with a human `label` + `description` |
