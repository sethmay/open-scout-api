...
| **Camps** | ✅ 487 entities — imported from [camp-finder](https://github.com/sethmay/camp-finder), classified by `camp_type` (376 resident, 69 day, 42 high-adventure) and `operator` (483 council + 4 national bases: Philmont, Florida Sea Base, Northern Tier, Summit/James C. Justice). Covers every camp the camp-finder site lists. Sessions/fees stay at the council site. |
