...
| 6 | **Rank requirement history** | ✅ `rank` + `requirement-set` (`subject: rank:*`) | 🌱 **SEEDED (0.8.0):** 7 Scouts BSA rank entities (Scout→Eagle) + 7 requirement-sets from the official 2024 Scouts BSA Requirements (No. 33216) — full verbatim tree, `text_rights` © Scouting America. Follow-ups: 2016/2022 historical revisions; Cub Scout / Venturing / Sea Scout rank entities. | 2024 Scouts BSA Requirements (No. 33216); scouting.org advancement |
