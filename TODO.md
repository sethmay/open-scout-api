...
| 5 | **Camps (registry + history)** | ✅ `camp` | 🌱 **SEEDED (0.7.0):** 469 camps imported from camp-finder (361 resident / 68 day / 40 high-adventure; 465 council + 4 national). Follow-ups: reservation `parent` nesting, `camp_type` refinement (day/HA heuristic), historical "lost camps", operator↔council coupling asserted in validate_data. | camp-finder dataset; scouting.org (national bases) |
