...
- **Scouting America "Council Service Territory" maps**: the authoritative source for
  ...
  name, HQ city, and territory assignment, none of which is subject to copyright
...
- **camp-finder** ([sibling project](https://github.com/sethmay/camp-finder)): an
...
- **English Wikipedia** (CC BY-SA): source for council **founding/rename/merger lineage
  ...
  (bsa-number continuity, live-council collision guard) but remain best-effort, so confirm
...
- **Guide to Awards and Insignia (No. 33066)**: the official Scouting America publication;
  ...
  numbers, wear location) are uncopyrightable; the Guide's
